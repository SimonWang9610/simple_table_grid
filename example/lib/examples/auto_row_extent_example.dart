...
class _AutoRowExtentExampleState extends State<AutoRowExtentExample> {
  ...
  void initState() {
    ...
    _controller = TableController(
      ...
      defaultRowExtent: Extent.ranged(max: 100),
      defaultColumnExtent: Extent.ranged(max: 150),
      columnExtents: {
        _nameColumn: Extent.fixed(pixels: 180),
        _notesColumn: Extent.fixed(pixels: 420),
      },
      initialRows: [
        RowData(
          const RowKey('r0'),
